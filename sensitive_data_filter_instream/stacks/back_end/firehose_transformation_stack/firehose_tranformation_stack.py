...
class GlobalArgs:
    ...
    REPO_NAME = "sensitive-data-filter-instream"
...
class FirehoseTransformationStack(core.Stack):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Read Lambda Code
        try:
            with open("sensitive_data_filter_instream/stacks/back_end/firehose_transformation_stack/lambda_src/kinesis_firehose_transformer.py",
                      encoding="utf-8",
                      mode="r"
                      ) as f:
        ...
        output_3 = core.CfnOutput(
            self,
            "SensitiveDataFilter",
            value=f"https://console.aws.amazon.com/lambda/home?region={core.Aws.REGION}#/functions/{fh_transformer_fn.function_name}",
